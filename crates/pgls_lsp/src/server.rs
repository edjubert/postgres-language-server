...
use crate::database_context::DbshDatabaseContextRequest;
use crate::handlers;
use crate::session::{
...
impl ServerFactory {
    ...
    pub fn create_with_fs(
        ...
        builder = builder.custom_method(
            ...
            |server: &LSPServer, params: DbshDatabaseContextRequest| {
                ...
                async move {
                    ...
                    session.set_dbsh_database_context(params.context);
