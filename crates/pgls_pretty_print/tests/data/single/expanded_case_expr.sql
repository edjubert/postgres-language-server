-- pgls-format: layout=expanded, lineWidth=200, indentStyle=tabs, indentSize=4, keywordCase=upper, constantCase=upper, typeCase=upper, commaStyle=leading, logicalOperatorPlacement=leading, castStyle=operator, clauseBodyStyle=break
SELECT
    CASE
